 ...
 *
 * Based on T-Deck-Pro/config/lv_conf.h with LV_FONT_MONTSERRAT_16 enabled
 * for PDA MAIN_FONT usage.
 */
...
/*Default display refresh period. Slow for E-Paper*/
...
#define LV_FONT_MONTSERRAT_16 1  /* Enabled for PDA MAIN_FONT */
